...
CREATE TABLE `product_users` (
  ...
  KEY `productId` (`productId`),
  KEY `userId` (`userId`),
  CONSTRAINT `product_users_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `products` (`id`),
  CONSTRAINT `product_users_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
...
-- Dump completed on 2021-10-16 23:17:46
